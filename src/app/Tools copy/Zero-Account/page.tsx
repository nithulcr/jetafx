        ...
        <div className="max-w-[1460px] px-6 w-full mx-auto pt-20">
          <div className='relative'>
            <div className='fade-up max-w-2xl mx-auto text-center'>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 fade-up">Margin Calculator</h1>
            ...
            <div className='fade-up mt-8 mb-4 lg:mt-14 lg:mb-8'>
              <Heading
                ...
                title="Master Your Trades with Precision – Jeta FX Margin Calculator"
                subtitle="The Jeta FX Margin Calculator is an essential tool for smart risk management and precise trade planning. Instantly know how much margin is required to open and sustain your positions, so you can trade with clarity and efficiency."
          ...
          <div className="grid lg:grid-cols-2  items-start lg:gap-12 pt-10">
            <div className=" flex-1">
              ...
              <div className="mb-8  max-w-lg">
                <h3 className="text-xl font-default mb-3 text-white">Why Traders Use the Jeta FX Margin Calculator</h3>
                <ul className="list-none fw-200 mt-5 text-[#E6ECFF] opacity-70 space-y-3">
                  <li className='flex gap-2'>
                    <CheckIcon />

                    Accurate Margin Estimates – Calculate required margin for any currency pair and trade size with precision.</li>
                  <li className='flex gap-2'>
                    <CheckIcon />

                    Better Risk Control – Plan ahead and avoid unnecessary margin calls.</li>
                  <li className='flex gap-2'>
                    <CheckIcon />

                    Flexible Coverage – Supports major and minor forex pairs for diverse trading strategies.</li>
                  <li className='flex gap-2'>
                    <CheckIcon />

                    Fast & Simple – Get real-time results in a clean, user-friendly interface.</li>
                </ul>
              </div>

              <div className="mb-8  max-w-lg">
                <h3 className="text-xl font-default mb-3 text-white">How It Works</h3>
                <p className='text-[#E6ECFF] opacity-70'>In forex trading, knowing your required margin helps you maintain account stability and manage risk effectively. The Jeta FX Margin Calculator gives you accurate insights so you can make informed decisions every time you trade.</p>

                <ul className="list-none fw-200 mt-5 text-[#E6ECFF] opacity-70 space-y-3">
                  <li className='flex gap-2'><CheckIcon />Select your account currency</li>
                  <li className='flex gap-2'><CheckIcon />Choose your trading pair</li>
                  <li className='flex gap-2'><CheckIcon />Enter your lot size</li>
                  <li className='flex gap-2'><CheckIcon />Set your leverage</li>
                  <li className='flex gap-2'><CheckIcon />Instantly view the required margin</li>

                </ul>
                <p className='text-[#E6ECFF] opacity-70'>No complications. Just clear numbers in seconds.</p>
              </div>
            ...
            <div className="w-full flex lg:justify-end">
              <div className="max-w-xl w-full form-sec rounded-2xl p-5 lg:p-10 relative">
                <form className="space-y-5">
                  ...
                  <FormSelect label="Leverage" options={["1:100", "1:200", "1:500"]} />
                  <FormInput label="EUR/USD Size" placeholder="1.17025" />
                  <AnimatedButton href="" label="Calculate" className="white-btn w-full max-w-[300px] mt-6  lg:mt-10 mx-auto" />
                </form>
                {/* Results (mockup) */}
                <div className='mx-auto max-w-[280px] mt-8'>
                  <div className="flex justify-between items-center flex-col text-center">
                    <p className="  mb-3">Deposit amount to open the trade</p>
                    <div className="text-2xl font-bold text-white mb-3">US$1,170.25</div>
