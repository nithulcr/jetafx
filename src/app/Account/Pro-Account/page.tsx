...
const provideItems = [
  {
    label: "Minimum Deposit $10000",
    description: "Jetafx’s Premium Account enables you to make commission-free international trades without the requirement of a minimal deposit.",
    icon: (
  ...
  {
    label: "Leverage",
    description: "Leverage your trading perfections, multiplying beyond your dreams with an authentication of a maximum of 1:2000. ",
    icon: (
  ...
  {
    label: "Commission",
    description: "Use a Premium Account at Jetafx, and you will find no additional margin on each trade through a reliable broker.",
    icon: (
  ...
  {
    label: "Spreads From",
    description: "Ultra-low spreads for major and minor markets provide optimum trading conditions at all times. ",
    icon: (
      <svg width="26" height="26" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const tradingSpecs = [
  { label: "Spreads:", value: "From 0.5 pip" },
        ...
        <div className="max-w-[1460px] px-6 w-full mx-auto pt-20">
          <div className='relative'>
            <div className='fade-up max-w-2xl mx-auto text-center'>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 fade-up">Commission-free trading, no minimum deposit.</h1>
            ...
            <div className='fade-up mt-14 mb-4 lg:mt-24 lg:mb-8'>
              <Heading
                badgeText="Premium Account-free demo"
                title="Premium Account: Expanding Your Trading Potential"
                subtitle=""
