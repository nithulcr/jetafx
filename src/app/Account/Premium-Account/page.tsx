...
const provideItems = [
  {
    label: "Low Spreads",
    description: "Jetafx's Pro Account offers very low spreads bringing cost-effective trading with greater returns. Jetafx, as a trustworthy broker.",
    icon: (
  ...
  {
    label: "Leverage",
    description: "The Pro Account is tailored specifically to give and offer leverage that can be easily adjusted to fit your strategies, either as an amateur.",
    icon: (
  ...
  {
    label: "Commission",
    description: "A best broker naturally follows commission-based pricing for disciplined trading, hence making the operations of the organization.",
    icon: (
      <svg width="26" height="26" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_1_14059)">
          <path fillRule="evenodd" clipRule="evenodd" d="M33.6578 24.6502C33.6578 32.0802 26.9253 35.4202 17.5003 35.4202C8.07527 35.4202 1.34277 32.0802 1.34277 24.7027C1.34277 16.6252 5.38277 12.5327 13.4603 8.44024L10.6003 3.11274C10.4296 2.8459 10.3346 2.53775 10.3253 2.22115C10.3161 1.90455 10.3929 1.59136 10.5476 1.315C10.7024 1.03863 10.9292 0.809436 11.204 0.65186C11.4787 0.494283 11.7911 0.41423 12.1078 0.420237H23.5253C23.8221 0.427832 24.1121 0.510829 24.368 0.661416C24.6239 0.812004 24.8373 1.02523 24.9881 1.28103C25.1389 1.53682 25.2221 1.82678 25.2299 2.1236C25.2377 2.42043 25.1699 2.71436 25.0328 2.97774L21.5403 8.44024C29.6153 12.4777 33.6578 16.5702 33.6578 24.6502ZM19.0628 12.6377C19.0628 12.2233 18.8982 11.8259 18.6051 11.5329C18.3121 11.2399 17.9147 11.0752 17.5003 11.0752C17.0859 11.0752 16.6884 11.2399 16.3954 11.5329C16.1024 11.8259 15.9378 12.2233 15.9378 12.6377V14.2052C14.8787 14.246 13.871 14.6721 13.1039 15.4033C12.3367 16.1346 11.8629 17.1207 11.7715 18.1766C11.68 19.2325 11.9771 20.2854 12.6071 21.1377C13.2371 21.99 14.1565 22.5829 15.1928 22.8052L18.8753 23.6102C19.2527 23.6915 19.5867 23.9096 19.8128 24.2225C20.039 24.5355 20.1413 24.921 20.1 25.3049C20.0587 25.6888 19.8767 26.0438 19.5891 26.3014C19.3016 26.5591 18.9289 26.7011 18.5428 26.7002H16.4578C16.1345 26.7007 15.8191 26.601 15.5549 26.4147C15.2908 26.2285 15.0909 25.9649 14.9828 25.6602C14.9197 25.4604 14.817 25.2752 14.6808 25.1159C14.5447 24.9565 14.3778 24.8262 14.1903 24.7326C14.0027 24.639 13.7982 24.5842 13.589 24.5713C13.3798 24.5583 13.1702 24.5877 12.9725 24.6575C12.7749 24.7273 12.5933 24.8361 12.4386 24.9775C12.2839 25.1189 12.1592 25.29 12.072 25.4806C11.9848 25.6712 11.9368 25.8774 11.9309 26.087C11.925 26.2965 11.9614 26.505 12.0378 26.7002C12.3324 27.53 12.8542 28.2604 13.5438 28.808C14.2333 29.3557 15.0628 29.6986 15.9378 29.7977V31.3877C15.9378 31.8021 16.1024 32.1996 16.3954 32.4926C16.6884 32.7856 17.0859 32.9502 17.5003 32.9502C17.9147 32.9502 18.3121 32.7856 18.6051 32.4926C18.8982 32.1996 19.0628 31.8021 19.0628 31.3877V29.7977C20.1659 29.6723 21.1888 29.1597 21.9494 28.3509C22.7101 27.5422 23.1591 26.4898 23.2167 25.3811C23.2743 24.2723 22.9367 23.1791 22.264 22.2959C21.5912 21.4127 20.627 20.7968 19.5428 20.5577L15.8603 19.7527C15.5615 19.6916 15.2963 19.5212 15.1165 19.2748C14.9367 19.0285 14.8552 18.724 14.888 18.4208C14.9209 18.1176 15.0656 17.8375 15.2939 17.6354C15.5223 17.4332 15.8178 17.3235 16.1228 17.3277H18.5428C18.8664 17.3254 19.1827 17.4244 19.4472 17.6109C19.7118 17.7974 19.9113 18.0621 20.0178 18.3677C20.1632 18.7487 20.4518 19.0578 20.822 19.2289C21.1921 19.4 21.6145 19.4196 21.999 19.2835C22.3834 19.1475 22.6994 18.8665 22.8795 18.5006C23.0596 18.1347 23.0895 17.7129 22.9628 17.3252C22.6703 16.4943 22.1491 15.7629 21.4591 15.2154C20.7691 14.6678 19.9384 14.3263 19.0628 14.2302V12.6377Z" fill="#F5CB13" />
        </g>
        <defs>
  ...
  {
    label: "Spreads From",
    description: "Jetafx offers minimal spreads that reduce spread slippage and improve efficiency in trading.",
    icon: (
      <svg width="26" height="26" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const tradingSpecs = [
  { label: "Spreads:", value: "From 1.2 pip" },
  { label: "Contract Size:", value: "1 lot = 1000 units" },
  { label: "Fifth Decimal:", value: "" },
  ...
  { label: "Minimum trade size:", value: "60 Standard  lots per position" }
];
        ...
        <div className="max-w-[1460px] px-6 w-full mx-auto pt-20">
          <div className='relative'>
            <div className='fade-up max-w-2xl mx-auto text-center'>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 fade-up">Low-Cost Trading</h1>
              <p className="fade-up text-slate-200 mb-6 text-[#E6ECFF] opacity-70">
                Take your trading to the next level with our most advanced swap-free account. Best suited for experienced traders looking to unlock greater profits and optimize their trading strategies under ideal market conditions.
              </p>
            </div>
            <div className='fade-up mt-14 mb-4 lg:mt-24 lg:mb-8'>
              <Heading
                badgeText="pro account-free demo"
                title="Trading Advantages of Pro Account Low Spreads"
                subtitle=""
