...
export default function PricingSlider() {
    ...
    return (
        <section className="plans-section py-8 md:pt-26  md:pb-16 relative overflow-hidden">
            ...
            <div className='mt-12'>
                ...
                >
                    {plans.map((plan, i) => {
                        ...
                        else if (i === nextIdx) style = "0 opacity-100 z-10"; // Next to active, highlight less
                        else if (i === prevIdx || i === nextNextIdx) style = ""; // Farther faded

                        return (
                            <SwiperSlide key={i}>
                                <div className={`plan-card w-full p-7 flex flex-col items-center mx-auto min-h-[400px] transition-all duration-300 ${style}`}>
                                    {/* ...Content... */}
            ...
            <div className="text-[#E6ECFF]] mt-12 text-sm lg:mb-10 flex justify-center rounded-4xl items-center gap-2 bg-[linear-gradient(180deg,#121426_0%,#000000_100%)] w-fit px-6 py-2 mx-auto">
