...
export default function GlobeFeatureMatrix() {
    return (
        <section className="lg:py-22 py-14 overflow-hidden">
            ...
            <div
                className="max-w-[1460px] mx-auto relative flex flex-col items-center justify-center  px-6 mt-0 lg:mt-18"
            ...
            >
                ...
                {/* Vertical line */}
                <div className="md:block hidden absolute top-0 bottom-0 left-1/2 w-[3px] bg-gradient-to-b from-white to-black z-10 opacity-40" />
