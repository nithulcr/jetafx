...
type Props = {
  setCountRef: (el: HTMLSpanElement | null) => void;
};
    ...
    <div className="max-w-[1460px] hero-second-grid mx-auto px-6 py-6 flex gap-6 bg-transparent">
      ...
      <div className="relative blurry-card blurry-card1">
        ...
        <p className="text-slate-400 text-[15px] leading-normal mb-5 s-fade-up">
          Discover 2,200+ global markets including forex pairs, leading stocks,
          and commodities — all in one powerful platform built for growth and
          opportunity.
        </p>
      ...
      <div className="relative blurry-card blurry-card2 flex flex-col justify-between">
        ...
        <p className="text-slate-400 text-[15px] leading-normal mb-6 max-w-2xl s-fade-up">
          Take advantage of ultra-fast execution and live market depth. Trade in
          real time with infrastructure that keeps you aligned with every move.
        </p>
        <div className="blurry-card2-values relative md:block hidden s-fade-up">
          ...
          <div className="absolute-line-button">
            ...
            <span
              ref={setCountRef}
              data-target="1917.44"
              className="count-number absolute-line-mark w-fit bg-white text-black font-semibold px-3 py-1 rounded-full shadow text-xs"
            >
              0
            </span>
          </div>
          <div className="grid grid-cols-3">
            ...
            <div className="trade_rate_img_container relative">
              <Image
                src="/trade_rate.png"
                alt="trade rate"
                className="trade_rate_img"
                width={300}
                height={300}
              />
              <div
                className="count-number absolute left-[58%] top-[70%] bg-white px-3 py-1.5 rounded-full text-black font-bold text-xs flex items-center gap-1"
            ...
            <div className="relative flex flex-end">
              <div className="flex gap-2 min-w-[110px] ml-auto items-end relative">
                ...
                <div className="bg-[#232325] text-white/80 py-1 px-6 rounded-lg flex flex-col items-center min-w-[85px]">
                  ...
                  <span className="font-semibold text-sm">
                    <span ref={setCountRef} data-target="1" className="count-number">
                      0
                    </span>{" "}
                    min
                  </span>
        ...
        <Image
          src="/rate-graph.png"
          alt="rate graph"
          className="w-full md:hidden s-fade-up"
          width={300}
          height={300}
        />
      </div>
